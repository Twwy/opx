...
$dbPass = '';
$dbPort = '3306';
if(php_uname() == 'SAE LINUX ENVIRONMENT'){
...
class oexec{
	...
	public function op_query($sql, $type){
		$obj = new PDO("mysql:host={$this->dbHost};dbname={$this->dbName};charset=UTF-8;port={$this->dbPort}", $this->dbUser, $this->dbPass, Array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES'UTF8';"));
